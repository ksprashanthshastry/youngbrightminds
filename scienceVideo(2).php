  ...
  <div class="body_container">
    <div class="side_nav">
      ...
      <ul>
        ...
        <li><a class="text active" href="scienceVideo(2).php">General Science</a></li>
        <li><a class="text" href="englishVideo(2).php">English</a></li>
    ...
    <div class="main">
      ...
      <div class="table">
        ...
        $conn   = db_connect();
        //make a SQL query
        $sql    = "select GNO, TOPIC, EMBEDDED_CODE FROM generalscience generalscience where GNO>=7 and GNO <=10";
