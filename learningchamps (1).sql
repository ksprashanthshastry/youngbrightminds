...
--
-- Host: 127.0.0.1
-- Generation Time: May 26, 2020 at 07:55 AM
...
INSERT INTO `quizcontent` (`SNO`, `QUESTION`, `ANS`) VALUES
(1, 'How many legs does a spider have?', '8'),
(2, 'What’s the name of a place you go to see lots of a', 'zoo'),
(3, 'If you freeze water, what do you get?', 'ice'),
(4, 'In the nursery rhyme, Jack and Jill, what do Jack ', 'A pail of '),
(5, 'Where does the President of the United States live', 'white hous'),
(6, 'How many planets are in our solar system?', '8'),
(7, 'Which Disney movie is Elsa in?', 'frozen'),
(8, 'Who is Mickey Mouse’s girlfriend?', 'mini mouse'),
(9, 'Where does Santa Claus live?', 'North pole'),
(10, 'What do caterpillars turn into? ', 'Butterfly'),
(11, 'What do you use to write on a blackboard?', 'Chalk'),
(12, 'On which holiday do you go trick-or-treating?', 'Halloween'),
(13, 'Where is the Great Pyramid of Giza?', 'Egypt'),
(14, 'What do bees make?', 'honey'),
(15, 'How many days are in a year?', '365'),
(16, 'What kind of animal was Abu in Aladdin?', 'monkey'),
(17, 'In the nursery rhyme, who sat on a wall before hav', 'Humpty Dum'),
...
(61, 'The sun sets in the __________?', 'West'),
(62, 'Which is the largest mammal?', 'Blue Whale'),
(63, 'What type of gas do plants absorb?', 'Carbon dio'),
(64, 'How Many wonders are there in the world ?', '7'),
(65, 'How many years are there in one Millenium?', '1000'),
(66, 'Which of the following is an ocean?', 'india'),
(67, 'Which is the smallest continent?', 'Australia'),
(68, 'Which is the tallest mountain in the world?', 'Mount Ever'),
(69, 'Who founded Microsoft ?', 'Bill gates'),
(70, 'How many millimetres are there in a centimetre?', '10'),
(71, 'Which planet is known as the red planet?', 'Mars'),
(72, 'Which bird lays the largest eggs ?', 'Ostrich'),
(73, 'Which is the hardest substance available on earth?', 'Dimond'),
(74, 'Which animal is called the king of the jungle?', 'lion'),
(75, 'How many hours do we have in a day ?', '24'),
