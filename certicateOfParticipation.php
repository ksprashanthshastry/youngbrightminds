  ...
  <div class="body_container">
    ...
    <div class="main certificate">
      <div class="certificate_inner">
        <p style="font-size: 46px;padding: 0;font-family:'Croissant One';">Certificate of Participation</p><br><br>
        <p class="certificate_text">This certificate is to Congratulate</p>
        <p class="certificate_text" ><b>you for participating in this quiz.</b></p>
        <p class="certificate_text">You are amazing.</p>
