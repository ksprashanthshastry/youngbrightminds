...
<body>
  ...
  <div class="body_container">
    <div class="side_nav">
      ...
      <ul>
        <li><a class="text" href="rhymes.php">Nursery rhymes</a></li>
        <li><a class="text" href="mathVideo(1).php">Mathematics</a></li>
        <li><a class="text active" href="scienceVideo(1).php">General Science</a></li>
        <li><a class="text" href="englishVideo(1).php">English</a></li>
    ...
    <div class="main">
      ...
      <div class="table">
        <?php
         ...
         $conn   = db_connect();
         //make a SQL query
         $sql    = "select GNO, TOPIC, EMBEDDED_CODE FROM generalscience where GNO>=1 and GNO <=6";
