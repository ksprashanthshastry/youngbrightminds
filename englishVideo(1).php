  ...
  <div class="body_container">
    <div class="side_nav">
      ...
      <ul>
        ...
        <li><a class="text" href="scienceVideo(1).php">General Science</a></li>
        <li><a class="text active" href="englishVideo(1).php">English</a></li>
    ...
    <div class="main">
      ...
      <div class="table">
        ...
        $conn   = db_connect();
        //make a SQL query
        $sql    = "select ENO, TOPIC, EMBEDDED_CODE FROM english where ENO>=1 and Eno <=5";
